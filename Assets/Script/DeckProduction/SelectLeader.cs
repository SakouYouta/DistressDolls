...
public class SelectLeader : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        switch (leader)
        {
            case 1: changeButton.image.sprite = leaderImage[0];break;
            case 2: changeButton.image.sprite = leaderImage[1];break;
            case 3: changeButton.image.sprite = leaderImage[2];break;
        }
